...
export interface StoredNotification {
  ...
  type: 'new_user' | 'low_stock' | 'schedule' | 'new_sale' | 'new_product' | 'general' | 'workspace_invite' | 'workspace_message' | 'task_completed' | 'task_assigned' | 'leave_request' | 'approval_change_request';
  title: string;
  body: string;
  icon?: string;
  timestamp: number;
