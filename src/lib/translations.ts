...
export interface Translations {
  ...
  chatEmoji: string;
  chatBack: string;
  chatMessageActions: string;
  chatPresenceActive: string;
  chatPresenceActiveJustNow: string;
  chatPresenceActiveMinutesAgo: string;
  chatPresenceActiveHoursAgo: string;
  chatPresenceLastSeen: string;
  chatPresenceOffline: string;
  chatVoiceRecord: string;
  chatVoiceRecording: string;
  chatVoiceCancel: string;
  chatVoiceSend: string;
...
export const translations: Record<Language, Partial<Translations>> = {
  en: {
    ...
    helpReports:
      "Submit and review team reports — name, description, and an optional document upload or link, with admin review.",
    helpAutomations:
