      ...
      <input
        ...
        className={cn(
          isDateLike
            ...
            : "flex h-10 w-full rounded border border-gray-300 bg-white px-3 py-2 text-base text-gray-900 shadow-sm ring-offset-background file:border-0 file:bg-transparent file:text-sm file:font-medium file:text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:border-gray-500 focus-visible:ring-2 focus-visible:ring-gray-300/50 disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
