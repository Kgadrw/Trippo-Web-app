...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-white p-6 text-gray-900 shadow-[0_20px_50px_-12px_rgba(15,23,42,0.28)] transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 rounded-xl border border-gray-200/90",
  {
    variants: {
      side: {
